...
class DonationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post donations_url, params: { donation: { amount: @donation.amount, campaign_id: @donation.campaign_id, cycle: @donation.cycle, invited_by: @donation.invited_by, user_id: @donation.user_id } }
    end
  ...
  test "should update donation" do
    patch donation_url(@donation), params: { donation: { amount: @donation.amount, campaign_id: @donation.campaign_id, cycle: @donation.cycle, invited_by: @donation.invited_by, user_id: @donation.user_id } }
